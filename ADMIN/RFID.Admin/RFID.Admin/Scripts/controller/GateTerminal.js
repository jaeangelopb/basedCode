(function () {
    ...
    var GateTerminalController = function ($q, $rootScope, $scope, $mdToast, commonRequest) {
        ...
        var PageIndexChange = function (increment) {
            if (increment < 0 && $scope.GateTerminal.PageIndex === 1) return;

            if (increment > 0 && ($scope.GateTerminal.PageIndex + 1) > $scope.GateTerminal.totalPage) return;

            $scope.GateTerminal.PageIndex += increment;
            List();
        };
        ...
        var List = function () {
            ...
            var onSuccessful = function (response) {
                ...
                if ($scope.checkAll) {
                    var list = $scope.GateTerminal.data.map(a => a.GateTerminalID);
            ...
            var param = $.param({
                ...
                "pageindex": $scope.GateTerminal.PageIndex,
                "pagesize": $scope.GateTerminal.PageSize
            });
        ...
        var Init = function () {
            ...
            $scope.GateTerminal.name = "GateTerminal";
      //     $scope.mode = "edddit";
            $scope.GateTypes = [];
