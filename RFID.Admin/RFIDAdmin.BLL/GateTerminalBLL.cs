...
namespace RFID.Admin.BLL
{
    ...
    {
        public GateTerminalListEntityDC GetAllGateTerminalByAccountID(Guid AccountID, string Search, int PageIndex, int PageSize)
        {
            ...
            return membersrv.GetAllGateTerminalByID(AccountID.ToString(), Search, PageIndex, PageSize);
        }
